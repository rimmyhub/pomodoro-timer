...
- `v1.0.1` (2026-02-17): 설정 화면 `앱 종료` 버튼 추가  
  문서: `RELEASE_NOTES_v1.0.1.md`
- `v1.0.0` (2026-02-16): 타이머/휴식 플로우 및 설정/통계 개선  
  문서: `RELEASE_NOTES_v1.0.0.md`

## 릴리즈 에셋 체크섬
- `PomodoroBuddy-macOS-v1.0.0.zip`  
  `fc2f6aa055f21a9e92d729e7798f86fb26ad56307ed97b415a2817b4d087c2c8`
- `PomodoroBuddy-macOS-v1.0.1.zip`  
